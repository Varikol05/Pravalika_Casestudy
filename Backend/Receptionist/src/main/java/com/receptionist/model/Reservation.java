...
public class Reservation {
	...
	public Reservation(int reservationCode, int numberOfAdult, int numberOfChildren, String checkIn, String checkOut,
			int numberOfNights, String roomType, String name, String emailId, String phoneNumber, String gender,
			String address, boolean status, double rate) {
		super();
